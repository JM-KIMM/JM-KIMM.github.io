...
export const competitionActivities: Activity[] = [
  ...
  },
  {
    ...
    period: '2025.02 — 03',
    role: '1인 개발',
    summary: '한 번에 전달할 수 있는 컨텍스트가 제한된 환경에서 검색 결과를 첫 번째 LLM으로 요약·압축하고 두 번째 LLM이 최종 대응책을 생성하도록 연결했습니다.',
    points: ['ko-sbert·FAISS 상위 3개 유사 QA 검색', 'VARCO-8B로 핵심 근거 중심 컨텍스트 압축', 'Qwen2.5-14B로 최종 재발방지대책·향후조치 생성'],
    purpose: '긴 컨텍스트를 그대로 밀어 넣는 대신 모델별 역할을 나눠 중요한 안전 정보가 최종 답변까지 전달되는 구조를 만들고자 했습니다.',
