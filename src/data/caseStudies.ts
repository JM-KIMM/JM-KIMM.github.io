...
export const caseStudies: Record<string, CaseStudy> = {
  'inha-world-model': {
    ...
    ownershipNote: '3인 팀의 리더로 World Model 학습·추론과 재현 파이프라인을 담당했습니다. 공개 저장소에 최종 설정뿐 아니라 실패한 가설, 폐기한 실험과 규정 판단까지 기록했습니다.',
    brief: {
    ...
    validation: {
      verified: ['3인 팀 리더로 2026 인하 인공지능 챌린지 우수상을 받았습니다.', 'Public 0.187244와 최종 Private 0.21395를 구분해 기록했습니다.', '로컬 16GB 환경에서 약 2일 학습하고 216개 영상을 57.9분에 생성했습니다.', '최종 학습·추론 설정과 실패 실험을 재현 문서로 공개했습니다.'],
