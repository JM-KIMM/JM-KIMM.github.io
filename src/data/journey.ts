...
export const journeyChapters: JourneyChapter[] = [
  {
    ...
    title: '인하-동동(同動) · 팀장',
    body: '학습공동체 팀장으로 목표와 역할을 정하고 일정, 주차별 활동과 회고를 관리했습니다. 팀이 같은 기준으로 움직이도록 학습 과정을 문서화해 우수상을 받았습니다.',
    handoff: '팀 운영에서 만든 기록 방식을 다음 학기에는 팀원의 입장에서 다시 경험했습니다.',
  },
  {
    period: '2025-1',
    stage: '02 · EXPLAIN TOGETHER',
    title: '인하-동동(同動) · 팀원',
    body: '두 번째 학기에는 팀원으로 참여해 학습 내용을 서로 설명하고 풀이를 피드백하는 협업 방식에 집중했습니다.',
    handoff: '운영자와 참여자 두 역할에서 익힌 협업 방식을 이후 알고리즘 학습과 팀 프로젝트에 이어갔습니다.',
  },
  {
    period: '2025',
    stage: '03 · BUILD BASICS',
  ...
  },
  {
    ...
    stage: '12 · TEST ON INDUSTRY DATA',
    title: 'LG Aimers 9기',
