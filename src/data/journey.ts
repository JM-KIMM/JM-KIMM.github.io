...
export const journeyChapters: JourneyChapter[] = [
  {
    ...
    title: '인하-동동(同動)',
    body: '학습공동체를 운영하며 목표, 역할, 주차별 활동과 회고를 기록했습니다. 혼자 잘 푸는 것보다 팀이 같은 기준으로 움직이게 만드는 과정이 먼저라는 점을 배웠습니다.',
    handoff: '공통 기준을 문서화하는 습관을 알고리즘 풀이와 팀 프로젝트 운영에 이어갔습니다.',
  },
  {
    period: '2025',
    stage: '02 · BUILD BASICS',
  ...
  },
  {
    ...
    stage: '11 · TEST ON INDUSTRY DATA',
    title: 'LG Aimers 9기',
  ...
  {
    period: '2026.07 — 08',
    stage: '13 · PREDICT THE NEXT STATE',
