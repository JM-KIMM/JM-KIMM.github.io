...
const projectEntries: Project[] = [
  ...
  },
  {
    ...
    role: '데이터셋 구축 · 모델 비교 · 논문 작성',
    ownership: '메시지 라벨링 · 모델 벤치마크 · 논문 작성',
    team: '논문 연구 / 후속 서비스 구현 5인 팀',
    metric: '18,270',
